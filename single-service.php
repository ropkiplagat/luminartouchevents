...
<div class="page-hero">
	<div class="container page-hero__content">
		<span class="page-hero__eyebrow"><?php esc_html_e( 'Event Styling Service', 'avideas' ); ?></span>
		...
		<nav class="page-hero__breadcrumb" aria-label="<?php esc_attr_e( 'Breadcrumb', 'avideas' ); ?>">
			...
			<a href="<?php echo esc_url( home_url( '/services/' ) ); ?>"><?php esc_html_e( 'Services', 'avideas' ); ?></a>
			<span aria-hidden="true"> / </span>
...
<section class="section section--cream service-single">
	<div class="container">
		...
		<div class="service-single__grid">
			...
			<figure>
				<img
					src="<?php echo esc_url( avideas_placeholder_img( 400, 600, get_the_title() ) ); ?>"
			...
			<div>
				<span class="section-header__eyebrow" style="display:block; margin-bottom:0.75rem;">
					<?php esc_html_e( 'Brisbane Event Styling', 'avideas' ); ?>
				</span>
				...
				<div class="service-includes" style="margin-bottom:var(--sp-md);">
					<h3 style="font-size:1rem; margin-bottom:1rem;"><?php esc_html_e( "What's Included", 'avideas' ); ?></h3>
					<ul class="service-includes__list">
						...
						$includes = $includes_meta
							? explode( "\n", $includes_meta )
							: [
								esc_html__( 'Personalised consultation & concept development', 'avideas' ),
								esc_html__( 'Full setup and professional styling on the day', 'avideas' ),
								esc_html__( 'Floral & decorative elements', 'avideas' ),
								esc_html__( 'Balloon installations (where applicable)', 'avideas' ),
								esc_html__( 'Complete pack-down after your event', 'avideas' ),
								esc_html__( 'Professional photography coordination support', 'avideas' ),
							];
				...
				<a href="<?php echo esc_url( home_url( '/contact/?service=' . urlencode( $slug ) ) ); ?>" class="btn btn--primary btn--lg">
					<?php esc_html_e( 'Book This Service', 'avideas' ); ?>
				</a>
...
<section class="section section--blush">
	<div class="container">
		<h2 class="text-center" style="margin-bottom:var(--sp-lg);"><?php esc_html_e( 'Other Services You May Love', 'avideas' ); ?></h2>
		<div class="services-grid reveal-stagger">
			...
			while ( $related->have_posts() ) :
				...
				$img = has_post_thumbnail()
					...
					: avideas_placeholder_img( 800, 600, get_the_title() );
			?>
			<a href="<?php the_permalink(); ?>" class="service-card">
				...
				<div class="service-card__body">
					...
					<span class="service-card__link"><?php esc_html_e( 'Learn More', 'avideas' ); ?> &rarr;</span>
				</div>
			</a>
